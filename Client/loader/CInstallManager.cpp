...
SString CInstallManager::_PrepareLaunchLocation()
{
    ...
    for (const char* fileName : {"eax.dll", "ogg.dll", "vorbis.dll", "vorbisFile.dll", "vorbisHooked.dll", "Hooks.asi", "$fastman92limitAdjuster.asi", "fastman92limitAdjuster_GTASA.ini", "GUI.fp", "FirstPerson.sp", "msvcr100d.dll"})
    {
